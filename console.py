...
class1 = GymClass(spin, '06:00', 30, location1, 8)
class2 = GymClass(spin, '07:00', 30, location1, 8)
class3 = GymClass(spin, '11:00', 45, location1, 8)
class4 = GymClass(spin, '14:00', 45, location1, 8)
class5 = GymClass(spin, '17:00', 45, location1, 8)
class6 = GymClass(spin, '18:00', 30, location1, 8)
class7 = GymClass(pilates, '08:00', 25, location2, 15)
class8 = GymClass(pilates, '09:00', 25, location2, 15)
class9 = GymClass(pilates, '10:00', 40, location2, 15)
class10 = GymClass(pilates, '12:00', 40, location2, 15)
class11 = GymClass(pilates, '15:00', 30, location2, 15)
class12 = GymClass(hiit, '11:00', 30, location2, 10)
class13 = GymClass(hiit, '17:00', 30, location2, 10)
class14 = GymClass(hiit, '20:00', 45, location2, 10)
class15 = GymClass(aquafit, '13:00', 30, location3, 10)
